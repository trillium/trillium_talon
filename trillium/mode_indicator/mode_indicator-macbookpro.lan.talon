...
settings():
    ...
    # Circle center X (0=left, 0.5=center, 1=right)
    ...
    user.mode_indicator_bar_right_x = 0.62
    # Text column 1 X - command/previous, left of circle (0=left, 1=right)
    user.mode_indicator_text_left_x = 0.7
    # Text column 2 X - usage/week, right of camera island (0=left, 1=right)
    user.mode_indicator_text_right_x = 0.556
    # Bar text top-row Y in pixels from screen top (bottom row is +12px)
    user.mode_indicator_text_y = 11
