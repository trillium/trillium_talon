...
file create relative: user.vscode("andreas.newFile")
file create root: user.vscode("fileutils.newFileAtRoot")
file rename:
    user.vscode("andreas.renameFile")
    sleep(150ms)
file move:
    user.vscode("andreas.moveFile")
    sleep(150ms)
file clone:
...
terminal (trash | close): user.vscode("workbench.action.terminal.kill")
